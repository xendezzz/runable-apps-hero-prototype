(() => {
  ...
  cover.src=poster;cover.alt='App demo placeholder';cover.className='demo-cover';cover.loading='lazy';cover.decoding='async';
  frame.append(cover);
  play.setAttribute('aria-label','App preview coming soon');
  const dialog=document.createElement('dialog');dialog.className='demo-dialog';dialog.setAttribute('aria-labelledby','demo-title');
  dialog.innerHTML='<div class="demo-dialog-inner"><div class="demo-dialog-header"><span id="demo-title">App preview coming soon</span><button class="demo-close" type="button" aria-label="Close video">×</button></div><div class="demo-stage"></div></div>';
  ...
  async function close(){
    ...
    document.body.style.overflow=scrollStyle;play.setAttribute('aria-label','App preview coming soon');
